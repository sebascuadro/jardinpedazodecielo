...
/* Cambio de nombre de perfil de usuario */
...
if ( ! isset( $wp_roles ) )
	...
	$wp_roles->roles['contributor']['name'] = 'Maestra';
    $wp_roles->role_names['contributor'] = 'Maestra';
	$wp_roles->roles['author']['name'] = 'Director';
    $wp_roles->role_names['author'] = 'Director';
}
